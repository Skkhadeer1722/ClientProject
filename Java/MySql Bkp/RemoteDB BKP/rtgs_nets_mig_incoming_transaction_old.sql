...
--
-- Table structure for table `incoming_transaction_old`
--

DROP TABLE IF EXISTS `incoming_transaction_old`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `incoming_transaction_old` (
