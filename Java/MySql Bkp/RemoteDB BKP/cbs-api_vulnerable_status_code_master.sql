...
--
-- Table structure for table `vulnerable_status_code_master`
--

DROP TABLE IF EXISTS `vulnerable_status_code_master`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `vulnerable_status_code_master` (
  `id` bigint NOT NULL,
  `active` int NOT NULL,
...
--
-- Dumping data for table `vulnerable_status_code_master`
--

LOCK TABLES `vulnerable_status_code_master` WRITE;
/*!40000 ALTER TABLE `vulnerable_status_code_master` DISABLE KEYS */;
/*!40000 ALTER TABLE `vulnerable_status_code_master` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-01-03 11:31:37
