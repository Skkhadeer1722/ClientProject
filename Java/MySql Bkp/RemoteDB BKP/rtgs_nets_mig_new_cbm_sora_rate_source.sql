...
--
-- Table structure for table `cbm_sora_rate_source`
--
...
--
-- Dumping data for table `cbm_sora_rate_source`
--

LOCK TABLES `cbm_sora_rate_source` WRITE;
/*!40000 ALTER TABLE `cbm_sora_rate_source` DISABLE KEYS */;
/*!40000 ALTER TABLE `cbm_sora_rate_source` ENABLE KEYS */;
UNLOCK TABLES;
