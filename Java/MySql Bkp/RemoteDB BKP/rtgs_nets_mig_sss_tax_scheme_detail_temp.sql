...
--
-- Table structure for table `sss_tax_scheme_detail_temp`
--

DROP TABLE IF EXISTS `sss_tax_scheme_detail_temp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sss_tax_scheme_detail_temp` (
  ...
  CONSTRAINT `fk_tax_scheme_detail_temp_tax_scheme` FOREIGN KEY (`tax_scheme_id`) REFERENCES `tax_scheme` (`id`)
...
--
-- Dumping data for table `sss_tax_scheme_detail_temp`
--

LOCK TABLES `sss_tax_scheme_detail_temp` WRITE;
/*!40000 ALTER TABLE `sss_tax_scheme_detail_temp` DISABLE KEYS */;
INSERT INTO `sss_tax_scheme_detail_temp` VALUES ('c0c47ee2-2c4e-4634-b0df-73be40b2a6bb','22d5ad2a-df08-44c7-a9a9-31eb17d4866c','24Local',0.0000000000),('d96b4712-ec84-41b6-a9ad-2a718a239431','289bdfe2-843b-4291-a943-316178ebb82f','Standard-rated',8.0000000000),('e71758e6-eb00-4a66-9fff-91c401718ac5','3b1d02c3-2bd7-4047-ba67-b9f4233a58ea','Exempt',0.0000000000);
/*!40000 ALTER TABLE `sss_tax_scheme_detail_temp` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-01-03 11:32:41
