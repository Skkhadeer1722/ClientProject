...
--
-- Table structure for table `cbm_cost_centre_source`
--
...
--
-- Dumping data for table `cbm_cost_centre_source`
--

LOCK TABLES `cbm_cost_centre_source` WRITE;
/*!40000 ALTER TABLE `cbm_cost_centre_source` DISABLE KEYS */;
/*!40000 ALTER TABLE `cbm_cost_centre_source` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-01-03 11:34:40
