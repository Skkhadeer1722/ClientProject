...
--
-- Table structure for table `cbm_liabilities_base_temp_old`
--

DROP TABLE IF EXISTS `cbm_liabilities_base_temp_old`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cbm_liabilities_base_temp_old` (
...
--
-- Dumping data for table `cbm_liabilities_base_temp_old`
--

LOCK TABLES `cbm_liabilities_base_temp_old` WRITE;
/*!40000 ALTER TABLE `cbm_liabilities_base_temp_old` DISABLE KEYS */;
INSERT INTO `cbm_liabilities_base_temp_old` VALUES ('0a991483-f61d-4c19-9378-b8f5d1fd963d','2','LBK','SGD','5','6','2021-06-10','2021-10-10',9.00000,'NULL','DELETED','0bdea729-4878-40b3-be91-7316aff49c86','2022-06-10 05:50:19','4d3921c4-9a6e-448d-b312-d282863d73d5','2022-06-10 05:50:19','2022-06-01 09:38:05','2022-05-29 18:30:00','approved',15);
/*!40000 ALTER TABLE `cbm_liabilities_base_temp_old` ENABLE KEYS */;
UNLOCK TABLES;
