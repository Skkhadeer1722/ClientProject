...
--
-- Table structure for table `sss_securities_position_stats_source`
--

DROP TABLE IF EXISTS `sss_securities_position_stats_source`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sss_securities_position_stats_source` (
...
--
-- Dumping data for table `sss_securities_position_stats_source`
--

LOCK TABLES `sss_securities_position_stats_source` WRITE;
/*!40000 ALTER TABLE `sss_securities_position_stats_source` DISABLE KEYS */;
/*!40000 ALTER TABLE `sss_securities_position_stats_source` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-01-03 11:31:58
