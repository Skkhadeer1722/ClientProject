...
--
-- Table structure for table `cbm_deposit_rate_temp`
--
...
--
-- Dumping data for table `cbm_deposit_rate_temp`
--

LOCK TABLES `cbm_deposit_rate_temp` WRITE;
/*!40000 ALTER TABLE `cbm_deposit_rate_temp` DISABLE KEYS */;
/*!40000 ALTER TABLE `cbm_deposit_rate_temp` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-01-03 11:34:46
