...
--
-- Table structure for table `sss_issuer_temp`
--

DROP TABLE IF EXISTS `sss_issuer_temp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sss_issuer_temp` (
...
--
-- Dumping data for table `sss_issuer_temp`
--

LOCK TABLES `sss_issuer_temp` WRITE;
/*!40000 ALTER TABLE `sss_issuer_temp` DISABLE KEYS */;
INSERT INTO `sss_issuer_temp` VALUES ('4ad71162-e15d-43be-b16f-064ac88fe7b3','MASxxxxx','Monetary Authority of Singapore','AGENCY',NULL,NULL,NULL,'SG',NULL,'ACTIVE','operatoruser2','2022-04-27 09:25:25','b1a38731-fb66-486c-9b0c-5c1045ffe4d6','2022-04-27 09:25:25','2022-04-26 18:30:00','2022-04-25 05:16:11','',2042,1),('537fe131-1c32-4628-90a8-d0968cd5527c','AGDxxxxx','Singapore Government','GOVERNMENT',NULL,NULL,NULL,'SG',NULL,'ACTIVE','operatoruser2','2022-04-27 09:25:20','b1a38731-fb66-486c-9b0c-5c1045ffe4d6','2022-04-27 09:25:20','2022-04-26 18:30:00','2022-04-25 05:22:28','',2041,1),('8165bb25-7b3f-48dd-81b9-0c56ddc2e395','Issuer12','Issuer 123','CORPORATE',NULL,NULL,NULL,'SG',NULL,'ACTIVE','operatoruser2','2022-04-25 05:18:02','operatoruser1','2022-04-25 05:18:02','2022-04-24 18:30:00','2022-04-18 11:23:38','',1980,1);
/*!40000 ALTER TABLE `sss_issuer_temp` ENABLE KEYS */;
UNLOCK TABLES;
