...
--
-- Table structure for table `sss_account_temp`
--

DROP TABLE IF EXISTS `sss_account_temp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sss_account_temp` (
  ...
  CONSTRAINT `fk_account_temp_custody_account_type` FOREIGN KEY (`custody_account_type_id`) REFERENCES `custody_account_type` (`id`),
  CONSTRAINT `fk_account_temp_member` FOREIGN KEY (`member_id`) REFERENCES `member` (`id`),
  CONSTRAINT `fk_account_temp_tax_profile` FOREIGN KEY (`tax_profile_id`) REFERENCES `tax_profile` (`id`)
...
--
-- Dumping data for table `sss_account_temp`
--

LOCK TABLES `sss_account_temp` WRITE;
/*!40000 ALTER TABLE `sss_account_temp` DISABLE KEYS */;
/*!40000 ALTER TABLE `sss_account_temp` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-01-03 11:31:56
