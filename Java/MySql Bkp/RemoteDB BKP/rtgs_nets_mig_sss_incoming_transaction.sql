...
--
-- Table structure for table `sss_incoming_transaction`
--

DROP TABLE IF EXISTS `sss_incoming_transaction`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sss_incoming_transaction` (
  ...
  `sender_member_code` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT 'Sender Member Code',
  ...
  `receiver_account_no` varchar(35) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT 'SSS Receiver account number',
...
--
-- Dumping data for table `sss_incoming_transaction`
--

LOCK TABLES `sss_incoming_transaction` WRITE;
/*!40000 ALTER TABLE `sss_incoming_transaction` DISABLE KEYS */;
INSERT INTO `sss_incoming_transaction` VALUES ('93e1b9b7-6d4c-4298-9a2e-b03432747628','ST2022060210472597906325',NULL,'SGSITSE04051','ESRC','FUTU',20220601,20220601,'SGD',100.00000,4000.00000,10.00000,'NULL','MASGSGSC',NULL,NULL,NULL,NULL,NULL,NULL,'2022-06-01 21:17:26','2022-06-01 21:17:29','sese.023.001.09',' ','NULL','receiver123','NULL',0,'APMT','096b44f4-1b0f-4a69-8a2f-727a80bd4de8','bc9eb452-851b-4367-84ae-775ce2aea818',NULL,'NULL',NULL,0,0,'NULL','ERF','2022-08-16 11:33:18',0.00000,'NULL',1.00000),('ba3f2b41-d2a3-4afd-8aed-56d950366306','ST2022060210472597906325',NULL,'SGSITSE04051','ESRC','FUTU',20220601,20220601,'SGD',100.00000,4000.00000,10.00000,'ZYSASGS0','NULL',NULL,NULL,NULL,NULL,NULL,NULL,'2022-06-01 21:17:26','2022-06-01 21:17:29','sese.023.001.09','NULL',' ','NULL','deliverer123',0,'APMT','096b44f4-1b0f-4a69-8a2f-727a80bd4de8','NULL','NULL',NULL,NULL,0,0,'CTR00002','NULL','2022-08-16 11:33:18',0.00000,NULL,1.00000);
/*!40000 ALTER TABLE `sss_incoming_transaction` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-01-03 11:32:29
