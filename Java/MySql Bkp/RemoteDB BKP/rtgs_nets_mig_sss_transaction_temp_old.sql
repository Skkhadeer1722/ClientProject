...
--
-- Table structure for table `sss_transaction_temp_old`
--

DROP TABLE IF EXISTS `sss_transaction_temp_old`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sss_transaction_temp_old` (
...
-- Dump completed on 2023-01-03 11:33:02
