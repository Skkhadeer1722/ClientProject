...
--
-- Table structure for table `cbm_sora_rate`
--

DROP TABLE IF EXISTS `cbm_sora_rate`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cbm_sora_rate` (
...
--
-- Dumping data for table `cbm_sora_rate`
--

LOCK TABLES `cbm_sora_rate` WRITE;
/*!40000 ALTER TABLE `cbm_sora_rate` DISABLE KEYS */;
/*!40000 ALTER TABLE `cbm_sora_rate` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-01-03 11:34:47
