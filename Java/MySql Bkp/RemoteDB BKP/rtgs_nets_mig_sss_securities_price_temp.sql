...
--
-- Table structure for table `sss_securities_price_temp`
--

DROP TABLE IF EXISTS `sss_securities_price_temp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sss_securities_price_temp` (
  ...
  CONSTRAINT `fk_securities_price_temp_securities_code` FOREIGN KEY (`securities_code`) REFERENCES `securities_code` (`securities_code`)
...
--
-- Dumping data for table `sss_securities_price_temp`
--

LOCK TABLES `sss_securities_price_temp` WRITE;
/*!40000 ALTER TABLE `sss_securities_price_temp` DISABLE KEYS */;
/*!40000 ALTER TABLE `sss_securities_price_temp` ENABLE KEYS */;
UNLOCK TABLES;
