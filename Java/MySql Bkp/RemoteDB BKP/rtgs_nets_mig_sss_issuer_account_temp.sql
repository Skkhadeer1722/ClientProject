...
--
-- Table structure for table `sss_issuer_account_temp`
--

DROP TABLE IF EXISTS `sss_issuer_account_temp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sss_issuer_account_temp` (
  ...
  CONSTRAINT `fk_issuer_account_temp_account` FOREIGN KEY (`sss_account`) REFERENCES `account` (`id`),
  CONSTRAINT `fk_issuer_account_temp_issuer` FOREIGN KEY (`issuer_id`) REFERENCES `issuer` (`id`),
  CONSTRAINT `fk_issuer_account_temp_member` FOREIGN KEY (`ipa`) REFERENCES `member` (`id`)
...
--
-- Dumping data for table `sss_issuer_account_temp`
--

LOCK TABLES `sss_issuer_account_temp` WRITE;
/*!40000 ALTER TABLE `sss_issuer_account_temp` DISABLE KEYS */;
INSERT INTO `sss_issuer_account_temp` VALUES (7,'8165bb25-7b3f-48dd-81b9-0c56ddc2e395','25ec94f7-7c66-458c-acde-6d8748729412','6c6ab966-8a4f-4d91-af0d-c8d15e61be63','SETT0200','111111111'),(8,'537fe131-1c32-4628-90a8-d0968cd5527c','25ec94f7-7c66-458c-acde-6d8748729412','1033be5a-eb96-4809-9ca8-1227e169af2e','26440200','22211121'),(9,'4ad71162-e15d-43be-b16f-064ac88fe7b3','25ec94f7-7c66-458c-acde-6d8748729412','1033be5a-eb96-4809-9ca8-1227e169af2e','26440200','11122211');
/*!40000 ALTER TABLE `sss_issuer_account_temp` ENABLE KEYS */;
UNLOCK TABLES;
