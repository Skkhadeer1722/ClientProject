...
--
-- Table structure for table `cbm_cost_centre`
--

DROP TABLE IF EXISTS `cbm_cost_centre`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cbm_cost_centre` (
...
--
-- Dumping data for table `cbm_cost_centre`
--

LOCK TABLES `cbm_cost_centre` WRITE;
/*!40000 ALTER TABLE `cbm_cost_centre` DISABLE KEYS */;
/*!40000 ALTER TABLE `cbm_cost_centre` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-01-03 11:32:06
