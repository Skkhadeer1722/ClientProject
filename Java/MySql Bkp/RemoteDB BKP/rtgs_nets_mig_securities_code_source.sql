...
CREATE TABLE `securities_code_source` (
  ...
  `central_bank_applied_amount` varchar(255) DEFAULT NULL,
  ...
  `first_issuance_amount` varchar(255) DEFAULT NULL,
  `first_issuance_date` varchar(255) DEFAULT NULL,
  `haircut_id` varchar(255) DEFAULT NULL,
  `ipa` varchar(255) DEFAULT NULL,
  `issue_code` varchar(255) DEFAULT NULL,
  `issue_price` varchar(255) DEFAULT NULL,
  `issue_yield` varchar(255) DEFAULT NULL,
  ...
  `record_date_period` varchar(255) DEFAULT NULL,
  ...
  `tenor_period` varchar(255) DEFAULT NULL,
  `tradable` varchar(255) DEFAULT NULL,
  `workflow_status_id` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
