...
--
-- Table structure for table `sss_tax_scheme`
--

DROP TABLE IF EXISTS `sss_tax_scheme`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sss_tax_scheme` (
