...
--
-- Table structure for table `sss_securities_code_statistics_temp_old`
--

DROP TABLE IF EXISTS `sss_securities_code_statistics_temp_old`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sss_securities_code_statistics_temp_old` (
...
--
-- Dumping data for table `sss_securities_code_statistics_temp_old`
--

LOCK TABLES `sss_securities_code_statistics_temp_old` WRITE;
/*!40000 ALTER TABLE `sss_securities_code_statistics_temp_old` DISABLE KEYS */;
INSERT INTO `sss_securities_code_statistics_temp_old` VALUES ('0f3ce294-f58a-4e35-a1e7-062ca2db0e08',10,10000,0,5000,'02-05-2022','02-05-2023','03-05-2023','2000','8000','2022-06-10 16:17:13','',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `sss_securities_code_statistics_temp_old` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-01-03 11:33:12
