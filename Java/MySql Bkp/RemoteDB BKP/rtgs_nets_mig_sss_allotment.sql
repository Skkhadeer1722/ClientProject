...
--
-- Table structure for table `sss_allotment`
--

DROP TABLE IF EXISTS `sss_allotment`;
...
--
-- Dumping data for table `sss_allotment`
--

LOCK TABLES `sss_allotment` WRITE;
/*!40000 ALTER TABLE `sss_allotment` DISABLE KEYS */;
/*!40000 ALTER TABLE `sss_allotment` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-01-03 11:32:59
