...
CREATE TABLE `name` (
  ...
  `preffered_name` varchar(255) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `FK6p4y5b707h8l5ivoyxs138j8s` (`customer_id`),
  CONSTRAINT `FK6p4y5b707h8l5ivoyxs138j8s` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`customer_id`)
...
INSERT INTO `name` VALUES (1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'SATYA','ndg',NULL,NULL,NULL,'HIM',NULL,NULL,NULL,'cf4b0154-49ca-4d0a-b5b1-94df58df933e');
