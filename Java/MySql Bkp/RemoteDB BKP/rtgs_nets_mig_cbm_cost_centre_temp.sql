...
--
-- Table structure for table `cbm_cost_centre_temp`
--
...
--
-- Dumping data for table `cbm_cost_centre_temp`
--

LOCK TABLES `cbm_cost_centre_temp` WRITE;
/*!40000 ALTER TABLE `cbm_cost_centre_temp` DISABLE KEYS */;
/*!40000 ALTER TABLE `cbm_cost_centre_temp` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-01-03 11:32:46
