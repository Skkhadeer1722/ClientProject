...
--
-- Table structure for table `sss_tax_scheme_temp`
--

DROP TABLE IF EXISTS `sss_tax_scheme_temp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sss_tax_scheme_temp` (
...
-- Dump completed on 2023-01-03 11:32:19
