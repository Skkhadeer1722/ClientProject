...
CREATE TABLE `cbm_liabilities_base_source` (
  ...
  `sector_id` varchar(20) DEFAULT NULL COMMENT 'Sector id',
  `currency_code` varchar(20) DEFAULT NULL COMMENT 'Currency code',
  `mcb_id` varchar(10) DEFAULT NULL COMMENT 'MCB id',
  `ql_lb_type` varchar(20) DEFAULT NULL COMMENT 'QL / LB items',
  `action` varchar(30) DEFAULT NULL,
  `status` varchar(30) DEFAULT NULL,
  `modified_by` varchar(36) DEFAULT NULL,
  `modified_date` varchar(36) DEFAULT NULL,
  `approved_by` varchar(36) DEFAULT NULL,
  `approved_date` varchar(36) DEFAULT NULL,
  `created_date` varchar(36) DEFAULT NULL,
  `effective_date` varchar(36) DEFAULT NULL,
  `approval_remark` varchar(140) DEFAULT NULL,
  `workflow_status_id` varchar(36) DEFAULT NULL
...
-- Dump completed on 2023-01-03 11:33:22
