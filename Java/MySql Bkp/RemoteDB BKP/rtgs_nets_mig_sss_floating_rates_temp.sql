...
--
-- Table structure for table `sss_floating_rates_temp`
--

DROP TABLE IF EXISTS `sss_floating_rates_temp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sss_floating_rates_temp` (
...
--
-- Dumping data for table `sss_floating_rates_temp`
--

LOCK TABLES `sss_floating_rates_temp` WRITE;
/*!40000 ALTER TABLE `sss_floating_rates_temp` DISABLE KEYS */;
/*!40000 ALTER TABLE `sss_floating_rates_temp` ENABLE KEYS */;
UNLOCK TABLES;
