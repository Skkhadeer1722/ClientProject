...
--
-- Table structure for table `cbm_liabilities_base_temp`
--
...
--
-- Dumping data for table `cbm_liabilities_base_temp`
--

LOCK TABLES `cbm_liabilities_base_temp` WRITE;
/*!40000 ALTER TABLE `cbm_liabilities_base_temp` DISABLE KEYS */;
/*!40000 ALTER TABLE `cbm_liabilities_base_temp` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-01-03 11:34:37
