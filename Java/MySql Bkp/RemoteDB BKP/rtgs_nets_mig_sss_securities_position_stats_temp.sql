...
--
-- Table structure for table `sss_securities_position_stats_temp`
--

DROP TABLE IF EXISTS `sss_securities_position_stats_temp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sss_securities_position_stats_temp` (
...
--
-- Dumping data for table `sss_securities_position_stats_temp`
--

LOCK TABLES `sss_securities_position_stats_temp` WRITE;
/*!40000 ALTER TABLE `sss_securities_position_stats_temp` DISABLE KEYS */;
/*!40000 ALTER TABLE `sss_securities_position_stats_temp` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-01-03 11:32:31
