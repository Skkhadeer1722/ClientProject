...
--
-- Table structure for table `sss_member_temp`
--

DROP TABLE IF EXISTS `sss_member_temp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sss_member_temp` (
  ...
  CONSTRAINT `fk_member_temp_billing_profile` FOREIGN KEY (`billing_profile_id`) REFERENCES `billing_profile` (`id`),
  CONSTRAINT `fk_member_temp_facility_eligibility` FOREIGN KEY (`facility_eligibility_id`) REFERENCES `facility_eligibility` (`id`),
  CONSTRAINT `fk_member_temp_member_status` FOREIGN KEY (`member_status`) REFERENCES `member_status` (`id`),
  CONSTRAINT `fk_member_temp_member_type` FOREIGN KEY (`member_type`) REFERENCES `member_type` (`id`),
  CONSTRAINT `fk_member_temp_tax_profile` FOREIGN KEY (`tax_profile_id`) REFERENCES `tax_profile` (`id`)
...
--
-- Dumping data for table `sss_member_temp`
--

LOCK TABLES `sss_member_temp` WRITE;
/*!40000 ALTER TABLE `sss_member_temp` DISABLE KEYS */;
/*!40000 ALTER TABLE `sss_member_temp` ENABLE KEYS */;
UNLOCK TABLES;
