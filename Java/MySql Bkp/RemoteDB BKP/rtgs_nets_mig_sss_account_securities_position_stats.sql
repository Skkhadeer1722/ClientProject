...
--
-- Table structure for table `sss_account_securities_position_stats`
--

DROP TABLE IF EXISTS `sss_account_securities_position_stats`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sss_account_securities_position_stats` (
...
--
-- Dumping data for table `sss_account_securities_position_stats`
--

LOCK TABLES `sss_account_securities_position_stats` WRITE;
/*!40000 ALTER TABLE `sss_account_securities_position_stats` DISABLE KEYS */;
/*!40000 ALTER TABLE `sss_account_securities_position_stats` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-01-03 11:32:39
