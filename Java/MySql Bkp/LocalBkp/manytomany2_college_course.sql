...
--
-- Host: localhost    Database: manytomany2
-- ------------------------------------------------------
...
CREATE TABLE `college_course` (
  ...
  KEY `FK3pnbl1o98c8vxdmg9flrcpvb` (`college_id`),
  CONSTRAINT `FK3pnbl1o98c8vxdmg9flrcpvb` FOREIGN KEY (`college_id`) REFERENCES `college` (`id`),
  CONSTRAINT `FKnmk2p0yq5blvgjqaktjmf0fpw` FOREIGN KEY (`course_id`) REFERENCES `course` (`id`)
...
-- Dump completed on 2023-01-09  9:19:32
