...
--
-- Table structure for table `securities_code`
--

DROP TABLE IF EXISTS `securities_code`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `securities_code` (
  ...
  CONSTRAINT `fk_securities_code_approved_by` FOREIGN KEY (`approved_by`) REFERENCES `user` (`id`),
  CONSTRAINT `fk_securities_code_currency_param` FOREIGN KEY (`currency_code`) REFERENCES `currency_param` (`currency_code`),
  CONSTRAINT `fk_securities_code_facility_eligibility` FOREIGN KEY (`facility_eligibility_id`) REFERENCES `facility_eligibility` (`id`),
  CONSTRAINT `fk_securities_code_haircut` FOREIGN KEY (`haircut_id`) REFERENCES `haircut` (`id`),
  CONSTRAINT `fk_securities_code_issuer` FOREIGN KEY (`issuer_id`) REFERENCES `issuer` (`id`),
  CONSTRAINT `fk_securities_code_member` FOREIGN KEY (`ipa`) REFERENCES `member` (`id`),
  CONSTRAINT `fk_securities_code_modified_by` FOREIGN KEY (`modified_by`) REFERENCES `user` (`id`),
  CONSTRAINT `fk_securities_code_securities_type` FOREIGN KEY (`securities_type_id`) REFERENCES `securities_type` (`id`),
  CONSTRAINT `fk_securities_code_tax_scheme` FOREIGN KEY (`tax_scheme_id`) REFERENCES `tax_scheme` (`id`)
...
--
-- Dumping data for table `securities_code`
--

LOCK TABLES `securities_code` WRITE;
/*!40000 ALTER TABLE `securities_code` DISABLE KEYS */;
INSERT INTO `securities_code` VALUES ('BCSISMBIL001','BN2005M','MAS Bill','TBill','A','daily','SGD',1000,'537fe131-1c32-4628-90a8-d0968cd552dr','cc4812ad-5c87-4729-a093-858687bd1fa4',NULL,NULL,1,'2021-05-18',20210519,100000000,20251231,NULL,1000.00000,0.00000,100000000,'Zero coupon','N',0.00000,0.00000,' ','Nearest',1,' ','ACTIVE','c93c6b81-0ef2-47e8-baef-714d14cd4b3c','2022-12-23 05:46:42','c93c6b81-0ef2-47e8-baef-714d14cd4b3c','2022-12-23 05:46:42','2022-12-23 05:46:42','2022-12-23 05:46:42','Data Migration',NULL,241,0.00000,0.00,'Fixed maturity','f9f56571-5e96-4295-88ec-0a5e57a971c1','NOT_APPLICABLE',NULL),('BCSISTEST012','N999012M','15 YEARS BONDS','SGSISGBond','A','yearly','SGD',1000,'537fe131-1c32-4628-90a8-d0968cd552dr','cc4812ad-5c87-4729-a093-858687bd1fa4',NULL,NULL,1,'2017-01-22',20170201,630000000,20290801,NULL,1000.00000,0.00000,630000000,'Fixed rate','S',1.25000,0.00000,'30/360','Nearest',6,' ','ACTIVE','c93c6b81-0ef2-47e8-baef-714d14cd4b3c','2022-12-23 05:46:43','c93c6b81-0ef2-47e8-baef-714d14cd4b3c','2022-12-23 05:46:43','2022-12-23 05:46:43','2022-12-23 05:46:43','Data Migration',NULL,15,0.00000,0.00,'Fixed maturity','f9f56571-5e96-4295-88ec-0a5e57a971c1','NOT_APPLICABLE',NULL),('MEPSUAT00016','GX16501W','10YR SBOND 2016 DUE220426 GX16501W','SSB','A','yearly','SGD',500,'537fe131-1c32-4628-90a8-d0968cd552dr','cc4812ad-5c87-4729-a093-858687bd1fa4',NULL,NULL,1,'2016-04-21',20160422,287500,20260422,NULL,1000.00000,0.00000,287500,'Fixed Multiple','S',NULL,0.00000,'30/360','Nearest',4,' ','ACTIVE','c93c6b81-0ef2-47e8-baef-714d14cd4b3c','2022-12-23 05:46:43','c93c6b81-0ef2-47e8-baef-714d14cd4b3c','2022-12-23 05:46:43','2022-12-23 05:46:43','2022-12-23 05:46:43','Data Migration',NULL,10,0.00000,0.00,'Fixed maturity','f9f56571-5e96-4295-88ec-0a5e57a971c1','NOT_APPLICABLE',20221022),('MEPSUAT00024','GX16502N','10YR SBOND 2016 DUE250426 GX16502N','SSB','A','yearly','SGD',500,'537fe131-1c32-4628-90a8-d0968cd552dr','cc4812ad-5c87-4729-a093-858687bd1fa4',NULL,NULL,1,'2016-04-22',20160425,300000,20260425,NULL,1000.00000,0.00000,300000,'Fixed Multiple','S',NULL,0.00000,'30/360','Nearest',4,' ','ACTIVE','c93c6b81-0ef2-47e8-baef-714d14cd4b3c','2022-12-23 05:46:44','c93c6b81-0ef2-47e8-baef-714d14cd4b3c','2022-12-23 05:46:44','2022-12-23 05:46:44','2022-12-23 05:46:44','Data Migration',NULL,10,0.00000,0.00,'Fixed maturity','f9f56571-5e96-4295-88ec-0a5e57a971c1','NOT_APPLICABLE',20221025),('MEPSUAT00032','GX16503V','10YR SBOND 2016 DUE 030526 GX16503V','SSB','A','yearly','SGD',500,'537fe131-1c32-4628-90a8-d0968cd552dr','cc4812ad-5c87-4729-a093-858687bd1fa4',NULL,NULL,1,'2016-04-29',20160503,137500,20260503,NULL,1000.00000,0.00000,137500,'Fixed Multiple','S',NULL,0.00000,'30/360','Nearest',4,' ','ACTIVE','c93c6b81-0ef2-47e8-baef-714d14cd4b3c','2022-12-23 05:46:44','c93c6b81-0ef2-47e8-baef-714d14cd4b3c','2022-12-23 05:46:44','2022-12-23 05:46:44','2022-12-23 05:46:44','Data Migration',NULL,10,0.00000,0.00,'Fixed maturity','f9f56571-5e96-4295-88ec-0a5e57a971c1','NOT_APPLICABLE',20221103),('NPTESTSCREEN','NY15046C','10YR BOND 2016 DUE 260531 NY15046C','SGSISGBond','N','yearly','SGD',1000,'537fe131-1c32-4628-90a8-d0968cd552dr','cc4812ad-5c87-4729-a093-858687bd1fa4',NULL,NULL,1,'2016-05-28',20160531,1000,20260531,NULL,1000.00000,0.00000,0,'Fixed rate','S',0.00000,0.00000,'30/360','Nearest',4,' ','ACTIVE','c93c6b81-0ef2-47e8-baef-714d14cd4b3c','2022-12-23 05:46:45','c93c6b81-0ef2-47e8-baef-714d14cd4b3c','2022-12-23 05:46:45','2022-12-23 05:46:45','2022-12-23 05:46:45','Data Migration',NULL,10,0.00000,0.00,'Fixed maturity','f9f56571-5e96-4295-88ec-0a5e57a971c1','NOT_APPLICABLE',NULL),('NSBONDMAY002','NS21002A','NS BOND 3YR 2021 - 2024 NS21002A','SGSISGBond','A','yearly','SGD',1000,'537fe131-1c32-4628-90a8-d0968cd552dr','cc4812ad-5c87-4729-a093-858687bd1fa4',NULL,NULL,1,'2021-05-05',20210506,100000,20240531,NULL,1000.00000,0.00000,100000,'Fixed rate','S',2.15000,0.00000,'30/360','Nearest',4,' ','ACTIVE','c93c6b81-0ef2-47e8-baef-714d14cd4b3c','2022-12-23 05:46:45','c93c6b81-0ef2-47e8-baef-714d14cd4b3c','2022-12-23 05:46:45','2022-12-23 05:46:45','2022-12-23 05:46:45','Data Migration',NULL,5,0.00000,0.00,'Fixed maturity','f9f56571-5e96-4295-88ec-0a5e57a971c1','NOT_APPLICABLE',20221130);
/*!40000 ALTER TABLE `securities_code` ENABLE KEYS */;
UNLOCK TABLES;
