...
public class ReportController {
	...
	public void loadData() {
		jasperFileNames = Arrays.asList("ACCOUNT_DETAIL_REPORT", "ACCOUNT_POSITION_DETAIL_REPORT",
				...
				"CBM_LIABILITIES_BASE_REPORT", "CBM_LIABILITIES_BASE_DETAIL_REPORT","CBM_GL_ACCOUNT_DETAIL_REPORT", "SSS_ALLOTMENT_DETAIL_REPORT",
				...
				"SSS_SECURITIES_POSITION_STATS_DETAIL_REPORT", "REPO_CLOSING_TRANSACTION_REPORT","SSS_SUMMARY_REPORT","ACCOUNT_SUMMARY_REPORT","CONTROL_TOTAL_REPORT");
	}
	...
	public String generateReport(String format, String iDate, String reportName) throws Exception {
		...
		if (jasperFileNames.contains(reportName)) {
			...
			logger.error("Invalid Report Name --> {}", reportName);
		return null;
	}
