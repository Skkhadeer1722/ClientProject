...
@Data
@AllArgsConstructor
public class CbmSoraRateReportDto {
	private String x_reference_rate;
	private String y_reference_rate;
	private String z_reference_rate;
	private String x_value_date;
	private String y_value_date;
	private String z_value_date;	
	private String x_publication_date;
	private String y_publication_date;
	private String z_publication_date;
