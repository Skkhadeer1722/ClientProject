...
//	private String password = "testPassword";
	...
	public void decryptZipFile(File encrypted, File decrypted)
	...
	private void encodeFileToBase64(File inputFile, File outputFile) {
		try {
	...
	public boolean compareTextFiles(File oldHashFile, File newHashFile) throws IOException {
		try (BufferedReader r1 = new BufferedReader(new FileReader(oldHashFile));
				BufferedReader r2 = new BufferedReader(new FileReader(newHashFile));) {
			int c1 = 0, c2 = 0;
			while (true) {
				c1 = r1.read();
				c2 = r2.read();
