package scrips.datamigration.config;
...
public class MySqlConfig {
 ...
 entityManagerFactory(
  ...
  return builder
   ...
   .packages("scrips.datamigration.rtgs.model",
		   "scrips.datamigration.sss.model",
		   "scrips.datamigration.rtgs.repository","scrips.datamigration.sss.repository"
		  ,"scrips.datamigration.fileupload","scrips.datamigration.common", "scrips.datamigration.csv.service",
		  "scrips.datamigration.common.service", "scrips.datamigration.rtgs.service", "scrips.datamigration.sss.service")
