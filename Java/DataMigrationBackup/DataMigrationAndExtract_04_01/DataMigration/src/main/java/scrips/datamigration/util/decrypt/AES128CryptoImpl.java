...
public class AES128CryptoImpl implements IntfCrypto {
	 ...
	 */
	// 15-Feb-2017 - Suma - MEPSUAT-2017-0035_17- Start
	//public AES128CryptoImpl(String salt, String passCode, int iterationCount) {
	public AES128CryptoImpl(char[] salt, char[] passCode, int iterationCount) {
	// 15-Feb-2017 - Suma - MEPSUAT-2017-0035_17- End
		this.salt = salt;
	 ...
	 */
	// 15-Feb-2017 - Suma - MEPSUAT-2017-0035_17- Start
	//public AES128CryptoImpl(String salt, String passCode) {
	public AES128CryptoImpl(char[] salt, char[] passCode) {
	// 15-Feb-2017 - Suma - MEPSUAT-2017-0035_17- End
		this.salt = salt;
		this.passCode = passCode;
